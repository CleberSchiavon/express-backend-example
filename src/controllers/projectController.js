...
exports.getAllProjects = (response, projects) => {
  return response.status(200).json(projects);
}

exports.getProjectsById = (request, response,projects) => {
...
exports.createAProject = (request,response,projects) => {
...
exports.editAProduct = (request,response,projects) => {
...
exports.deleteAProduct = (request, response, projects) => {
    // Pegando os parametros que foram enviados com a rota
    const { id } = request.params;
